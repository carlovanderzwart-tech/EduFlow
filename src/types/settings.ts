 ...
 * tijdstempels — docs/archief/03 beperkt die tot entiteiten met meerdere exemplaren.
 *
 * Alles hier bevat eigen tekst of een verwijzing en staat daarom in IndexedDB,
 * niet in localStorage (besluit T-01).
 */
export interface Settings {
  /** Staat bij een nieuwe documentatie vast ingevuld (docs/archief/04, scherm 6). */
