...
De agenda voelt als de agenda-app die je al kent (B-85).

## Lees dit, en niet meer

- `docs/06-2-modules-agenda.md` — §6.2.5 t/m §6.2.9 (snelveld, herhalen, verplaatsen,
  ICS, meldingen). Let op: §6.2.9 is op 11 augustus herschreven door B-86
- `docs/BESLUITEN.md` — B-85 en B-86
...
| `FR-AGE-25` | **Meldingen werken alleen terwijl EduFlow open is** (B-86) |
...
is B-86 en het is geen bezuiniging maar een grens: het zou een derde server en een derde
