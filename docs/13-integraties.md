...
|---|---|---|---|
| ~~Microsoft Graph (Microsoft 365)~~ | — | **Vervallen op 11 augustus 2026, zie B-106** | de beheerdersgoedkeuring is afgewezen |
| ~~Gmail API (Google Workspace)~~ | — | **Vervallen op 11 augustus 2026, zie B-106** | volgt Microsoft: één mailroute of geen |
...
geen OAuth, geen tokens. Zie de herschreven §6.3 en besluit B-106. Wat overblijft is de
