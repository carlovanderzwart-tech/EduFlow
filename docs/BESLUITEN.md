...
- **O-01 — Stijlvoorbeelden** *(§19.5, ongewijzigd)*. Drie of vier paren van een ruwe
  ...
  niet in te vullen.**
- **O-03 — Gesprek functionaris gegevensbescherming** *(§19.5)*. Door B-82 verschuift het
...
- **O-05 — Nulmeting** *(§19.5)*. Twaalf documentaties handmatig geklokt, 24 augustus tot
  18 september 2026. Door B-81 blokkeert dit de bouw niet meer.
- **O-06 — Vakantiebestand vullen** *(§19.5)*. Drie regio's, met versienummer en
  `validUntil` (§13.4). §19.5 zegt "vóór sprint 4"; door B-85 is dat vervroegd naar
